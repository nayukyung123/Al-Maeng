              ...
              <div className="flex-1 w-full max-w-md space-y-8 shrink-0">
                ...
                <div className="space-y-4">
                  ...
                  <div className="relative border-b border-black pb-2">
                    <textarea value={ticketData.review} onChange={(e) => setTicketData({ ...ticketData, review: e.target.value })} placeholder="이 책이 남긴 여운을 한 줄로 적어주세요." className="w-full text-lg font-medium outline-none placeholder:text-gray-300 resize-none h-16 bg-transparent" />
                  </div>
                </div>
