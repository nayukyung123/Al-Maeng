...
const MOCK_CONTENT_RECOMMENDATIONS: Banner[] = [
  ...
  },
  {
    ...
    books: [
      { title: "안나 카레니나", copy: "파괴적인 사랑의 끝에서 발견하는 인간의 본성.", seed: "anna" },
      { title: "참을 수 없는 존재의 가벼움", copy: "사랑과 존재의 무거움에 대하여.", seed: "lightness" },
  ...
  },
  {
    ...
    books: [
      ...
      { title: "미드나잇 라이브러리", copy: "수많은 삶 중 내가 선택한 단 하나의 삶.", seed: "midnight" },
      { title: "우리가 빛의 속도로 갈 수 없다면", copy: "우주적 고독 속에서 피어나는 연대.", seed: "lightspeed" },
    ],
  },
];
